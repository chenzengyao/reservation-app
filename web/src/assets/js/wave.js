!function(t, e) {
    ...
    function c(t) {
        ...
        if (null !== e) {
            if (e.disabled || e.getAttribute("disabled") || e.classList.contains("disabled"))
                return;
            if (h.registerEvent(t),
            "touchstart" === t.type && v.delay) {
                var n = !1
                ...
                v.show(t, e),
                m && (e.addEventListener("touchend", v.hide, !1),
    ...
    var l = l || {}
      ...
      , v = {
        ...
        show: function(t, e, n) {
            ...
            o.className = "waves-ripple waves-rippling",
            e.appendChild(o);
            var a = i(e)
              , s = 0
              , u = 0;
        ...
        hide: function(t, e) {
            for (var n = (e = e || this).getElementsByClassName("waves-rippling"), o = 0, a = n.length; o < a; o++)
                s(t, e, n[o]);
            m && (e.removeEventListener("touchend", v.hide),
      ...
      , h = {
        ...
        allowEvent: function(t) {
            var e = !0;
            return /^(mousedown|mousemove)$/.test(t.type) && h.touches && (e = !1),
            e
        },
    ...
    return l.init = function(t) {
        ...
        m && (e.addEventListener("touchstart", c, !1),
