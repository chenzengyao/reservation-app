...
export class MenusService {
  ...
  add(item_category: String, item_name: String, item_description: String, item_price: String,
    item_remark: String, item_status: String, item_image: String, item_created_dt: String,  
    created_by: String) {
    console.log("item_name", item_name);
    return this.http.post(`/menu/add?item_name=` + item_name + '&item_category=' + item_category + '&item_description=' + item_description + '&item_price=' + item_price + 
