...
import { ClientLayoutComponent } from './clientlayouts/layout.component';
...
const routes: Routes = [
  ...
  { path: 'user', component: ClientLayoutComponent, loadChildren: () => import('./clientpages/pages.module').then(m => m.PagesModule), canActivate: [AuthGuard] },
